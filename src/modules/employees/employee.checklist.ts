import type { ChecklistTemplate, EmployeePosition, EmployeeType } from './employee.types';
...
export const OPERATOR_BORDER_TEMPLATE: ChecklistTemplate[] = [
  ...
  { type: 'internal_regulations',    label: 'Reglamento interno firmado',       required: true  },
  { type: 'employment_application',  label: 'Solicitud de empleo',              required: true  },
  { type: 'proof_of_address',        label: 'Comprobante de domicilio',         required: true  },
  { type: 'background_check',        label: 'Carta de no antecedentes penales', required: true  },
  { type: 'socioeconomic_study',     label: 'Estudio socioeconómico',           required: true  },
  { type: 'federal_license',         label: 'Licencia federal de conducir',     required: true  },
  { type: 'state_license',           label: 'Licencia estatal',                 required: false },
  { type: 'sct_medical_exam',        label: 'Examen médico SCT',               required: true  },
  { type: 'company_medical_exam',    label: 'Examen médico empresa',            required: true  },
...
export const ADMIN_TEMPLATE: ChecklistTemplate[] = [
  ...
  { type: 'company_medical_exam',    label: 'Examen médico empresa',            required: true  },
  { type: 'drug_test_mx',            label: 'Drug Test (México)',               required: true  },
  { type: 'federal_license',         label: 'Licencia federal de conducir',     required: false },
  { type: 'state_license',           label: 'Licencia estatal',                 required: false },
  { type: 'dot_physical',            label: 'DOT Physical (FMCSA)',             required: false },
  { type: 'drug_test_us',            label: 'Drug Test (FMCSA USA)',            required: false },
  { type: 'technical_certification', label: 'Certificación técnica',            required: false },
];
